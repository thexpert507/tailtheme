...
import { MODAL_SIZES, ROUNDED, cn } from "@/utils";
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        size ? MODAL_SIZES[size] : MODAL_SIZES.xl,
        round ? ROUNDED[round] : ROUNDED.md,
        "translate-x-[-50%] translate-y-[-50%] duration-200",
        "gap-4 border p-6 shadow-lg bg-background-primary",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      ...
      <DialogPrimitive.Close
        className={cn(
          ...
          "text-background-contrast hover:bg-background-secondary",
